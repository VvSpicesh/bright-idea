...
export const SIX_HAND_POINTS = {
  大安: { x: 111, y: 190, finger: '食指', section: '下节' },
  留连: { x: 111, y: 92, finger: '食指', section: '上节' },
  速喜: { x: 166, y: 77, finger: '中指', section: '上节' },
  赤口: { x: 221, y: 92, finger: '无名指', section: '上节' },
  小吉: { x: 221, y: 190, finger: '无名指', section: '下节' },
  空亡: { x: 166, y: 205, finger: '中指', section: '下节' },
} as const

export const NINE_HAND_POINTS = {
  大安: { x: 111, y: 142, finger: '食指', section: '中节' },
  留连: { x: 111, y: 92, finger: '食指', section: '上节' },
  速喜: { x: 166, y: 92, finger: '中指', section: '上节' },
  赤口: { x: 221, y: 142, finger: '无名指', section: '中节' },
  小吉: { x: 166, y: 190, finger: '中指', section: '下节' },
  空亡: { x: 166, y: 142, finger: '中指', section: '中节' },
  病符: { x: 221, y: 92, finger: '无名指', section: '上节' },
  桃花: { x: 111, y: 190, finger: '食指', section: '下节' },
  天德: { x: 221, y: 190, finger: '无名指', section: '下节' },
} as const
