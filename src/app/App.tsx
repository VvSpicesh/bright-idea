    ...
    <div className="result-layout">
      ...
      <div className="revealed-result">
        <div className={animationComplete ? 'result-right-top' : 'result-right-top is-animation-pending'} aria-hidden={!animationComplete}>
          ...
          <DivinationInterpretation passes={passes} direction={direction} question={question} ruleSystemId={result.ruleSystemId} method={source.method} onDirectionChange={setDirection} />
        </div>
