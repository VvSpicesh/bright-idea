...
export const sixPalaceKnowledge = {
  大安: {
    ...
    heavenlyStems: '本资料未提供', earthlyBranches: '本资料未提供', numberSymbols: [1, 4, 5],
  },
  留连: {
    ...
    heavenlyStems: '本资料未提供', earthlyBranches: '本资料未提供', numberSymbols: [2, 7, 8],
  },
  速喜: {
    ...
    heavenlyStems: '本资料未提供', earthlyBranches: '本资料未提供', numberSymbols: [3, 6, 9],
  },
  赤口: {
    ...
    heavenlyStems: '本资料未提供', earthlyBranches: '本资料未提供', numberSymbols: [4, 1, 2],
  },
  小吉: {
    ...
    heavenlyStems: '本资料未提供', earthlyBranches: '本资料未提供', numberSymbols: [5, 6, 10],
  },
  空亡: {
    ...
    heavenlyStems: '本资料未提供', earthlyBranches: '本资料未提供', numberSymbols: [6, 5, 10],
  },
